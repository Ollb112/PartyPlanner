        ...
        while(!parametro.equals("S")) {
            ...
            switch (parametro) {
                case "1":
                    ...
                    String c = leitor.nextLine().toUpperCase();
                    System.out.println("Digite seu email:");
                    String d = leitor.nextLine();
                    Cliente s = new Cliente(a ,Sexo.valueOf(c),b,d);
                ...
                case "2":
                    if(cdi.getTodosOsClientes().size() != 0) {
                        for (Cliente x : cdi.getTodosOsClientes()) {
                ...
                case "4":
                    ...
                    Cliente c1 = cdi.recuperarClientePorEmail(email);
                    if(c1 != null) {
                ...
                case "8":
                    ...
                    for(Evento evento : cdi.todosOsEventos){
                    	if (!evento.jaOcorreu()) {
                    		System.out.println(evento);
                    	}
                    }
                    ...
                    for(Evento evento : cdi.todosOsEventos){
                    	if (evento.getNome().equals(nomeDoEvento)) {
                    		...
                    		mensagem.enviarEmailParaCliente(evento, conteudo);
