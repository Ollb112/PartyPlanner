		...
		public void actionPerformed(ActionEvent e) {
			...
			switch (acao){
				...
				if (linhaSelecionada == -1)
					...
					String opcao = (String)JOptionPane.showInputDialog(Janela.getInstance(), "Qual desses você irá cadastrar?", null, JOptionPane.QUESTION_MESSAGE, null, servicos.toArray(), "Party Planner");
