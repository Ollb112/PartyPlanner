...
public class OuvinteDoPainelAdm implements ActionListener{
	...
	public void actionPerformed(ActionEvent clique) {
		...
		case "Cadastrar":
			...
			break;	
		case "Listar":
			String opcaoListar = (String)JOptionPane.showInputDialog(Janela.getInstance(), "Qual desses você irá cadastrar?", null, JOptionPane.QUESTION_MESSAGE, null, opcoesListar, "Party Planner");
