					...
					try {
						if(user.getEmail().equals(email)) {
							if(user.getSenha().equals(senha)) {
								...
								SenhaInvalidaException erro = new SenhaInvalidaException();
								throw erro;
							}
						}
						else {
							EmailInvalidoException erro = new EmailInvalidoException(email);
							throw erro;
						}	
					}
					catch(EmailInvalidoException erro) {
						JOptionPane.showMessageDialog(null, erro.getErro(),"E-mail Invalido ",JOptionPane.WARNING_MESSAGE);
						break;
					}
					catch(SenhaInvalidaException erro) {
						JOptionPane.showMessageDialog(null, erro.getErro(),"Senha Invalida ",JOptionPane.WARNING_MESSAGE);
						break;
					}
				}
			case "Mostrar Senha":
