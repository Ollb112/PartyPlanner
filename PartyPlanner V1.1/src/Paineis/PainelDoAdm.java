...
public class PainelDoAdm extends JPanel{
	private MeuJButton cadastrar = new MeuJButton(450, 50, 100, 50,"Cadastrar");
	private MeuJButton listar = new MeuJButton(560, 50, 100, 50,"Listar");
	private MeuJButton planilha = new MeuJButton(450, 110, 210,50,"Gerar Planilha de Finanças");
